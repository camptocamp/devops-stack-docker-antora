...
Then, check if there is a new release available in the https://github.com/camptocamp/devops-stack-docker-antora/pkgs/container/devops-stack-antora[`Packages`] separator on this repository.
